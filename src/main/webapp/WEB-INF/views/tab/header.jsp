...
<!-- Bootstrap core CSS -->
<%--<link href="<%=request.getContextPath()%>/webjars/bootstrap/4.3.1/css/bootstrap.min.css" rel="stylesheet">--%>
...
<link href="<%=request.getContextPath()%>/resources/vendor/css/agency.min.css" rel="stylesheet">
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav text-uppercase ml-auto">
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="<%=request.getContextPath()%>/">Services</a>
                </li>
                <li class="nav-item">
